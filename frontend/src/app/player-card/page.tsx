...
export default function PlayerCardPage() {
  ...
  return (
    <div className="app-container" style={{ maxWidth: "600px", alignItems: "center" }}>
      {/* Header */}
      <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", width: "100%", padding: "16px 0" }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <button onClick={() => router.push("/")} className="icon-btn" title={t("back")}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6"></polyline></svg>
          </button>
        </div>
        <h1 style={{ fontSize: "20px", margin: 0 }}>{t("playerCard")}</h1>
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          <button
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "24px" }}>
        <button onClick={() => changeMonth(-1)} className="icon-btn" style={{ width: "40px", height: "40px" }}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="15 18 9 12 15 6"></polyline></svg>
        </button>
        <span style={{ fontSize: "16px", fontWeight: 600, color: "var(--text-primary)", letterSpacing: "1px", textTransform: "uppercase" }}>
          {monthLabel || selectedMonth}
        </span>
        <button onClick={() => changeMonth(1)} className="icon-btn" style={{ width: "40px", height: "40px" }}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="9 6 15 12 9 18"></polyline></svg>
        </button>
      </div>
      ...
      {loading ? (
        ...
        <>
          {/* ═══ THE CARD ═══ */}
          <div ref={cardRef} className="player-card-wrapper" style={{ perspective: "1000px" }}>
            <div
          ...
          <div style={{
            ...
            <div style={{ fontSize: "13px", color: "var(--text-secondary)", marginBottom: "12px", fontWeight: 600, letterSpacing: "1px" }}>
              {t("breakdown")}
            </div>
              ...
              {(Object.keys(STAT_LABELS) as Array<keyof typeof STAT_LABELS>).map((key) => {
                ...
                return (
                  <div key={key} style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                    <span style={{ width: "24px", fontSize: "12px", fontWeight: 700, color: "var(--text-secondary)" }}>{STAT_LABELS[key]}</span>
                    ...
                    <span style={{ width: "28px", textAlign: "right", fontSize: "13px", fontWeight: 700, color: "var(--text-primary)" }}>{val}</span>
                  </div>
                );
              })}
            </div>
