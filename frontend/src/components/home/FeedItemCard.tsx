  ...
  return (
    <div className="food-item feed-item-card" style={{ padding: "12px 20px", borderLeft: `4px solid ${color}` }}>
      ...
      <div className="feed-item-actions">
        {onRelog && (
          <button type="button" className="icon-btn feed-item-action-btn" title={relogTitle} onClick={onRelog}>
        ...
        {onEdit && (
          <button type="button" className="icon-btn feed-item-action-btn" onClick={onEdit}>
        ...
        <button type="button" className="icon-btn delete-btn-hover feed-item-action-btn" onClick={onDelete}>
          <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
